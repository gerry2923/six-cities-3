...
//     setActiveCity(cityName); // устанавливаем названиек города
//     setActiveCityLocationTab(newLocation); // нужны координаты города, поэтому его сохраняем как объект типа TCity
//     setActiveOfferId(null); // активный город обнуляем
//   };
